...
class MorningRoutineScreen extends StatelessWidget {
  ...
  Widget _buildRoutineLayout(BuildContext context, String title, String bgImage, List<String> steps, {int completedCount = 0}) {
    return Scaffold(
                ...
                Expanded(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildStepItem(context, index + 1, steps[index], isCompleted);
                    },
                  ),
                ),
              ],
